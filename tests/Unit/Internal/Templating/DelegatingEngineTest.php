...
class DelegatingEngineTest extends \PHPUnit\Framework\TestCase
{
    public function testRender()
    {
        ...
        $delegatingEngine = new TemplateEngineBridge(['smarty' => $engine]);
    ...
    public function testSupportsTwoEngines()
    {
        ...
        $delegatingEngine = new TemplateEngineBridge(['smarty' => $engine1, 'twig' => $engine2]);
    ...
    public function testAddSecondEngine()
    {
        ...
        $delegatingEngine = new TemplateEngineBridge(['smarty' => $engine1]);
    ...
    {
        $delegatingEngine = new TemplateEngineBridge();
